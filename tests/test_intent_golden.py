...
GOLDEN = [
    ...
    ("open YouTube in an incognito browser", "open_website"),
    ("open an incognito browser", "open_browser"),
    ("search Google for privacy tools with Firefox", "search_browser"),
    ("set a timer for 10 minutes", "set_timer"),
    ("remind me in 30 minutes to stretch", "set_reminder"),
    ("list my reminders", "list_reminders"),
    ("what is my active window", "get_active_window"),
    ("show open windows", "list_windows"),
    ("show running apps", "list_running_apps"),
    ("what is my local IP address", "network_status"),
    ("research offline voice recognition", "research_web"),
    ("read webpage https://example.com/help", "read_webpage"),
    ("what is on my screen", "inspect_screen"),
    ("reopen the closed tab", "browser_action"),
    ("hello AXON", "chat"),
    ("thanks", "chat"),
