...
(``data/logs/AXON.log``) and auto-prunes both audit and log files beyond the
...
class AuditLogger:
    def __init__(self, config: Config, bus: EventBus) -> None:
        ...
        self.log = logging.getLogger("AXON")
    ...
    def _configure_logging(self) -> None:
        ...
        fh = logging.handlers.RotatingFileHandler(
            LOG_DIR / "AXON.log", maxBytes=2_000_000, backupCount=5,
            encoding="utf-8")
        fh.setFormatter(fmt)
