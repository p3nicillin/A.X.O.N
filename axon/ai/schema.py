...
COMMAND_TYPES: dict[str, str] = {
    ...
    "browser_navigate": "WEB_AUTOMATION",
    "browser_read_page": "WEB_AUTOMATION",
    "browser_click": "WEB_AUTOMATION", "browser_fill": "WEB_AUTOMATION",
    "browser_close_managed": "WEB_AUTOMATION",
    "list_workflows": "WORKFLOW_CONTROL",
    "resume_workflow": "WORKFLOW_CONTROL",
    "cancel_workflow": "WORKFLOW_CONTROL",
    "desktop_inspect": "DESKTOP_AUTOMATION",
    "desktop_click": "DESKTOP_AUTOMATION",
    "desktop_fill": "DESKTOP_AUTOMATION",
    "get_weather": "WEATHER",
    "calculate": "UTILITY",
