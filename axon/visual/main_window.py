"""The AXON window: HUD + the holographic core, on the Tkinter main thread.
...
class AxonWindow:
    ...
    def _build_hud(self) -> None:
        ...
        self._hud = {}
        # title
        self._hud["title"] = cv.create_text(34, 34, anchor="w", text="AXON",
        ...
        self._indicators = {}
        states = [("LISTENING", AxonState.LISTENING),
    ...
    def _set_state(self, state: AxonState) -> None:
        self.renderer.set_state(state)
        status = {
            AxonState.IDLE: ("ONLINE", _OK),
            AxonState.LISTENING: ("LISTENING", _ACCENT),
            AxonState.THINKING: ("PROCESSING", _ACCENT),
