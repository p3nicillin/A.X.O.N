"""JARVIS — a voice-driven, visually animated AI operating layer for Windows.

This package is organised into independent layers that communicate only through
the :class:`~jarvis.core.event_bus.EventBus`. No layer imports another layer's
internals, which keeps every piece modular and independently testable:
    ...
    visual/      -> the reactive holographic "JARVIS CORE" renderer
